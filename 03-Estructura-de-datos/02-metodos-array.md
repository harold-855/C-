...
💡 Nota aclaratoria:
En C#, Length no está disponible en todas las colecciones. Length se utiliza principalmente con arrays y tipos que representan una cantidad fija de elementos. Otras colecciones, como List<T>, utilizan la propiedad Count para conocer la cantidad de elementos.
...
En resumen: Length → arrays / Count → colecciones como List<T>.